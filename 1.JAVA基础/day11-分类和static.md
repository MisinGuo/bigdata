...
+ StudentController类  和用户打交道(接收用户需求,采集用户信息,打印数据到控制台)
  ...
  ![01_黑马信息管理系统分类](./11img/01_黑马信息管理系统分类.png)
...
![02_黑马信息管理系统介绍](./11img/02_黑马信息管理系统介绍.png)
...
+ 添加功能实现步骤 
  ...
  ![03_添加功能需求分析](./11img/03_添加功能需求分析.png)


+ 添加功能优化:判断id是否存在

  ![04_判断id是否存在](./11img/04_判断id是否存在.png)

+ 查询功能实现步骤

  ![05_查询功能需求分析](./11img/05_查询功能需求分析.png)

+ 删除功能实现步骤

  ![06_删除功能需求分析](./11img/06_删除功能需求分析.png)

+ 修改功能实现步骤 

  ![07_修改功能需求分析](./11img/07_修改功能需求分析.png)
...
+ 添加功能实现步骤
  ...
  ![10_添加老师功能实现步骤](./11img/10_添加老师功能实现步骤.png)

+ 查询功能实现步骤

  ![11_查询老师功能实现步骤](.\11img\11_查询老师功能实现步骤.png)

+ 删除功能实现步骤

  ![12_删除老师功能实现步骤](./11img/12_删除老师功能实现步骤.png)

+ 修改功能实现步骤

  ![13_修改老师功能实现步骤](./11img/13_修改老师功能实现步骤.png)
