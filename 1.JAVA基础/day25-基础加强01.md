...
+ 类加载过程
  ...
  1. 加载
     ...
     ![02_类加载过程加载](./25img/02_类加载过程加载.png)
  ...
  2. 链接
     ...
     ![03_类加载过程验证](./25img/03_类加载过程验证.png)
     ...
     ![04_类加载过程准备](./25img/04_类加载过程准备.png)
     ...
     ![05_类加载过程解析](./25img/05_类加载过程解析.png)
  ...
  3. 初始化
     ...
     ![06_类加载过程初始化](./25img/06_类加载过程初始化.png)
...
+ 三种方式分类
  ...
  ![08_获取Class对象的三种方式](./25img/08_获取Class对象的三种方式.png)
...
![11_请求资源分类](./25img/11_请求资源分类.png)

+ 静态资源

  在服务器提前准备好的文件。(图片，文本)

  ![09_静态资源](.\25img\09_静态资源.png)
...
+ 优化步骤
  ...
  6. 修改处理DynamicResourceProcess中的process方法
     ...
     ![13_反射和配置文件优化](./25img/13_反射和配置文件优化.png)
