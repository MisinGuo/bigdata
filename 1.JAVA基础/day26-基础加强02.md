...
+ 常见的解析思想
  ...
  ![02_dom解析概述](./26img/02_dom解析概述.png)
...
+ DTD语法
  ...
  + 定义元素
    ...
    ![03_DTD语法定义元素](./26img/03_DTD语法定义元素.png)
...
+ schema和dtd的区别
  ...
  ![04_schema约束介绍](./26img/04_schema约束介绍.png)
...
+ 编写schema约束
  ...
  + 步骤
    ...
    ![05_schema约束编写](./26img/05_schema约束编写.png)
...
+ 准备xml文件
  ...
  4. 将要解析的数据配置到xml文件中
     ...
     ![06_配置要解析的Servlet数据](./26img/06_配置要解析的Servlet数据.png)
