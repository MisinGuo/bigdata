...
![tomcat官网](1img/tomcat官网.png)

### 2.1.3 Tomcat各版本所需支持

![Tomcat各版本使用技术支持](1img/Tomcat各版本使用技术支持.png)

### 2.1.4 Tomcat目录结构详解

![tomcat目录结构详解](1img/tomcat目录结构详解.png)
...
Tomcat服务器的启动文件在二进制文件目录中：![1574762703742](1img/1574762703742.png)，这两个文件就是Tomcat的启动文件。

Tomcat服务器的停止文件也在二进制文件目录中：![1574762805135](1img/1574762805135.png)，这两个文件就是Tomcat的停止文件。
...
![1574768107180](1img/1574768107180.png)
...
​			![1574768222804](1img/1574768222804.png)
...
![IDEA配置Tomcat1](1img/IDEA配置Tomcat1.png)

**第二步**

![IDEA配置Tomcat2](1img/IDEA配置Tomcat2.png)

**第三步**

![IDEA配置Tomcat3](1img/IDEA配置Tomcat3.png)

**第四步**

![IDEA配置Tomcat4](1img/IDEA配置Tomcat4.png)
...
![Linux版Tomcat](1img/Linux版Tomcat.png)
...
![1574768644245](1img/1574768644245.png)
...
![IDEA创建Javaweb工程](1img/IDEA创建Javaweb工程.png)

**第二步**

![创建Javaweb工程2](1img/创建Javaweb工程2.png)

**第三步**

![创建Javaweb工程3](1img/创建Javaweb工程3.png)

**第四步**

![创建Javaweb工程4](1img/创建Javaweb工程4.png)
...
![IDEA发布工程1](1img/IDEA发布工程1.png)

**第二步**

![IDEA发布工程2](1img/IDEA发布工程2.png)

**第三步**

![IDEA发布工程3-启动服务](1img/IDEA发布工程3-启动服务.png)

#### 2）war包发布

**第一步：使用<b>`jar -cvf war` <font color='blue'>包的名称</font>  <font color='purple'>当前目录中哪些资源要打入war</font></b>**

![jar命令](1img/jar命令.png)

![war包](1img/war包.png)

**第二步：把打好的war拷贝到tomcat的webapps目录中**

![拷贝war包到webapps](1img/拷贝war包到webapps.png)

**第三步：启动服务时，tomcat会自动解压。**

![启动Tomcat自动解压war包](1img/启动Tomcat自动解压war包.png)
...
![请求部分](1img/请求部分-1574824553003.jpg)
...
![响应部分](1img/响应部分-1574824560809.jpg)
...
![静态资源工程1](1img/静态资源工程1.png)

![静态资源工程2](1img/静态资源工程2.png)

**第二步：拷贝资源到工程的web目录中**

![静态资源工程3](1img/静态资源工程3.png)

**第三步：在web.xml中配置默认主页**

![静态资源工程4](1img/静态资源工程4.png)

**第四步：部署工程到Tomcat服务器**

![静态资源工程5](1img/静态资源工程5.png)

**第五步：测试浏览器访问**

![静态资源工程6](1img/静态资源工程6.png)

![静态资源工程7](1img/静态资源工程7.png)
...
![动态资源工程](1img/动态资源工程.png)

![动态资源工程1](1img/动态资源工程1.png)

**第二步：拷贝资源**

![动态资源工程2](1img/动态资源工程2.png)

**第三步：配置默认主页**

![动态资源工程4](1img/动态资源工程4.png)

**第四步：部署项目**

![动态资源工程3](1img/动态资源工程3.png)
...
![编写Servlet](1img/编写Servlet.png)

**第二步：重写service方法，输出一句话**

![重写Service方法](1img/重写Service方法.png)

**第三步：在web.xml配置Servlet**

![配置Servlet](1img/配置Servlet.png)
