...
![Servlet的API官网](2img/Servlet的API官网.png)
...
![ServletAPI详解](2img/ServletAPI详解.png)
...
![Servlet执行过程图](2img/Servlet执行过程图.jpg)
...
![Servlet类视图](2img/Servlet类视图.png)
...
![HttpServlet的使用1](2img/HttpServlet的使用1.png)

![HttpServlet的使用2](2img/HttpServlet的使用2.png)
...
![Servlet的线程安全问题](2img/Servlet的线程安全问题.png)
...
![Servlet映射1](2img/Servlet映射1.png)
...
![Servlet映射2](2img/Servlet映射2.png)
...
![Servlet映射3](2img/Servlet映射3.png)
...
![Servlet的优先级](2img/Servlet的优先级.png)
...
![Servlet的启动顺序](2img/Servlet的启动顺序.png)

#### 4）默认Servlet

默认Servlet是由服务器提供的一个Servlet，它配置在Tomcat的conf目录下的web.xml中。如下图所示：

![默认Servlet](2img/默认Servlet.png)
...
![Servlet类关系总视图](2img/Servlet类关系总视图.png)
...
![ServletConfig对象](2img/ServletConfig对象.png)
...
![ServletConfig演示](2img/ServletConfig演示.png)
...
![Servlet注解开发1](2img/Servlet注解开发1.png)

![Servlet注解开发2](2img/Servlet注解开发2.png)

![注解开发Servlet移除web.xml](2img/注解开发Servlet移除web.xml.png)
...
![注解配置Servlet映射](2img/注解配置Servlet映射.png)

**第四步：测试**

![注解配置Servlet测试](2img/注解配置Servlet测试.png)
...
![手动创建容器之创建工程](2img/手动创建容器之创建工程.png)

![手动创建容器之移除web.xml](2img/手动创建容器之移除web.xml.png)
...
![手动创建容器之初始化容器的配置](2img/手动创建容器之初始化容器的配置.png)

**第四步：编写注册Servlet的代码**

![手动创建容器之编写注册Servlet的代码](2img/手动创建容器之编写注册Servlet的代码.png)

**第五步：测试**

![手动创建容器之测试](2img/手动创建容器之测试.png)
